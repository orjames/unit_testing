...
it('correctly calculates the difference between 33 and 3', () => {
...
it('indicates failure when a string is used instead of a number', () => {
  assert.equal(operations.validateNumbers('owen', 5), false)
})
...
it('succesfully runs when two numbers are used', () => {
  assert.equal(operations.validateNumbers(2, 4), true)
})